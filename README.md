...
- **[procurement-genai-backend](../procurement-genai-backend)** — GenAI Q&A backend over the procurement knowledge graph
- **[procurement-ui](../procurement-ui)** — React frontend for chat, graph visualization, and trace display

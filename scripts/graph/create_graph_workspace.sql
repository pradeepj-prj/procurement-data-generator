...
--
-- Notes:
-- - Uses CREATE OR REPLACE VIEW for idempotent re-runs
-- - Graph workspace DROP is handled by deploy_graph.py (not supported in DDL blocks)
-- ============================================================================
...
CREATE OR REPLACE VIEW "PROCUREMENT"."V_VENDOR" AS
SELECT
...
CREATE OR REPLACE VIEW "PROCUREMENT"."V_MATERIAL" AS
SELECT
...
CREATE OR REPLACE VIEW "PROCUREMENT"."V_PLANT" AS
SELECT
...
CREATE OR REPLACE VIEW "PROCUREMENT"."V_CATEGORY" AS
SELECT
...
CREATE OR REPLACE VIEW "PROCUREMENT"."V_PURCHASE_ORDER" AS
SELECT
    po_id           AS vertex_id,
...
CREATE OR REPLACE VIEW "PROCUREMENT"."V_CONTRACT" AS
SELECT
...
CREATE OR REPLACE VIEW "PROCUREMENT"."V_INVOICE" AS
SELECT
...
CREATE OR REPLACE VIEW "PROCUREMENT"."V_GOODS_RECEIPT" AS
SELECT
    gr_id           AS vertex_id,
...
CREATE OR REPLACE VIEW "PROCUREMENT"."V_PAYMENT" AS
SELECT
...
CREATE OR REPLACE VIEW "PROCUREMENT"."V_PURCHASE_REQ" AS
SELECT
    pr_id           AS vertex_id,
...
-- ============================================================================
-- 2. UNIFIED VERTEX VIEW
-- ============================================================================

CREATE OR REPLACE VIEW "PROCUREMENT"."V_ALL_VERTICES" AS
...
CREATE OR REPLACE VIEW "PROCUREMENT"."E_SUPPLIES" AS
SELECT
...
CREATE OR REPLACE VIEW "PROCUREMENT"."E_ORDERED_FROM" AS
SELECT
...
CREATE OR REPLACE VIEW "PROCUREMENT"."E_CONTAINS_MATERIAL" AS
SELECT
...
CREATE OR REPLACE VIEW "PROCUREMENT"."E_UNDER_CONTRACT" AS
SELECT
    ROW_NUMBER() OVER (ORDER BY po_id, po_line_number) AS edge_id,
    po_id           AS source_vertex,
...
CREATE OR REPLACE VIEW "PROCUREMENT"."E_INVOICED_FOR" AS
SELECT
...
CREATE OR REPLACE VIEW "PROCUREMENT"."E_RECEIVED_FOR" AS
SELECT
...
CREATE OR REPLACE VIEW "PROCUREMENT"."E_PAYS" AS
SELECT
...
CREATE OR REPLACE VIEW "PROCUREMENT"."E_BELONGS_TO_CATEGORY" AS
SELECT
...
CREATE OR REPLACE VIEW "PROCUREMENT"."E_CATEGORY_PARENT" AS
SELECT
...
CREATE OR REPLACE VIEW "PROCUREMENT"."E_LOCATED_AT" AS
SELECT
    ROW_NUMBER() OVER (ORDER BY po_id) AS edge_id,
    po_id           AS source_vertex,
...
CREATE OR REPLACE VIEW "PROCUREMENT"."E_HAS_CONTRACT" AS
SELECT
...
CREATE OR REPLACE VIEW "PROCUREMENT"."E_REQUESTED_MATERIAL" AS
SELECT
...
CREATE OR REPLACE VIEW "PROCUREMENT"."E_INVOICED_BY_VENDOR" AS
SELECT
    ROW_NUMBER() OVER (ORDER BY invoice_id) AS edge_id,
    invoice_id      AS source_vertex,
    vendor_id       AS target_vertex,
...
CREATE OR REPLACE VIEW "PROCUREMENT"."E_PAID_TO_VENDOR" AS
SELECT
...
CREATE OR REPLACE VIEW "PROCUREMENT"."E_ALL_EDGES" AS
...
-- 5. GRAPH WORKSPACE
-- ============================================================================
-- Note: DROP GRAPH WORKSPACE is handled by deploy_graph.py before executing this SQL,
-- since HANA Cloud does not support DROP GRAPH WORKSPACE in anonymous blocks.
